...
let ny1= new Lover(1,'1','libra','1','1','111111111111111111111111111111')
let ny2= new Lover(2,'2','libra','2','2','222222222222222222222222222222222')
let ny3= new Lover(3,'3','libra','3','3','333333333333333333333333333333333')

loverManager.add(ny1)
loverManager.add(ny2)
loverManager.add(ny3)
...
function addLover() {
    let name = input.question(`name (less than 15 character) : `)
    if (name.length >= 15) {
        console.log(`the name cannot longer than 15 character!!`)
        addLover()
    } else {
        ...
        if (address.length >= 15) {
            ...
            if (dateOfBirth.value < 0) {
                ...
                let hobby = input.question(`hobby(longer than 15 character): `)
                if (hobby.length < 15) {
                    console.log(`hobby cannot less than 15 character!!`)
                    addLover();
                } else {
